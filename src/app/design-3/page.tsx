...
export default function Design3() {
  ...
  return (
    <div className="min-h-screen bg-navy-950">
      {/* Navigation - Sticky */}
      <nav className="sticky top-0 z-50 bg-navy-950/90 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center gap-3">
              ...
              />
              <div>
                <span className="text-white font-bold text-sm block">THE BIG TALK</span>
                <span className="text-white/50 text-xs">Simplifying the talk</span>
              </div>
            </Link>
            <div className="flex items-center gap-4">
              <div className="hidden md:flex items-center gap-3">
                {["TikTok", "IG", "X"].map((item) => (
                  <button
                    key={item}
                    className="text-white/50 hover:text-accent-coral text-xs font-medium px-3 py-1.5 rounded-full border border-white/10 hover:border-accent-coral/50 transition-all"
                  >
                    {item}
                  </button>
                ))}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-3 gap-4">
            ...
            <motion.div
              ...
              className="bg-navy-900/80 backdrop-blur-sm rounded-3xl p-6 border border-white/10"
            >
              ...
              <div className="relative aspect-video rounded-2xl overflow-hidden mb-4 bg-navy-800">
                <Image
              ...
              <h3 className="text-white font-bold mb-2">The Finance Bill Explained Simply</h3>
              <p className="text-white/50 text-sm mb-4">What it means for you and your family.</p>
            ...
            >
              {stats.slice(0, 2).map((stat, index) => (
                ...
                >
                  ...
                  <p className={`text-xs ${index === 0 ? "text-white/80" : "text-white/60"}`}>
                    {stat.label}
                  </p>
                </div>
              ))}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {contentPillars.map((pillar, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-accent-coral/50 hover:bg-white/10 transition-all cursor-pointer"
              >
                <div className="flex items-center gap-2 mb-4">
                ...
                <div className="mt-4 pt-4 border-t border-white/10">
                  <span className="text-white/50 text-sm group-hover:text-accent-coral transition-colors">
                    Explore content →
                  </span>
                </div>
              </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-white/50 text-sm">The voices behind the change</p>
            </div>
            <button className="text-accent-coral text-sm font-medium hover:underline">
              View All →
            </button>
      ...
      <section className="py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="bg-gradient-to-r from-accent-coral/20 to-accent-cyan/20 rounded-3xl p-8 md:p-12 border border-white/10"
          >
            <div className="text-center mb-10">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Our Impact in Numbers
              </h2>
              <p className="text-white/60">Real change, measured.</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <span className="text-white font-bold block">THE BIG TALK</span>
                <span className="text-white/50 text-xs">Simplifying the talk. Sparking the change.</span>
              </div>
            </div>
            <div className="flex items-center gap-4">
            ...
            <p className="text-white/30 text-sm">© 2024 The Big Talk</p>
          </div>
        </div>
      </footer>
